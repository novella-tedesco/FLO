...
(3)Information about data collection, privacy regulation and license
(4)Information about the corpus
(5)Transcription procedure and conventions
(6)Encoding
(7)Metadata
(8)Annotation schema
(9)Annotation procedures
...
A segment can be interrupted by brief segments spoken by other speakers (in such cases, the segment is not split, and overlapping parts are indicated in square brackets).
e.g.[Yeah it's wow it's just amazing] I have to say.// [Yeah yeah]
